...
public final class MeasureHelper {
    ...
    private int mCurrentAspectRatio = VideoType.AR_ASPECT_FIT_PARENT;
    ...
    public void doMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        Logger.d("doMeasure on surefaceview, w=" + View.MeasureSpec.getSize(widthMeasureSpec) + ", mode=" + View.MeasureSpec.getMode(widthMeasureSpec)
                + ", h=" + View.MeasureSpec.getSize(heightMeasureSpec) + ", mode=" + View.MeasureSpec.getMode(widthMeasureSpec) + "; videow=" + mVideoWidth + ", videoh=" + mVideoHeight + "; aspectRadioType=" + mCurrentAspectRatio);
        ...
        Logger.d("doMeasure defaultSize, w=" + width + ", h=" + height);
        if (mCurrentAspectRatio == VideoType.AR_MATCH_PARENT) {
            ...
            if (widthSpecMode == View.MeasureSpec.AT_MOST && heightSpecMode == View.MeasureSpec.AT_MOST) {
                ...
                Logger.d("doMeasure specSize, w=" + widthSpecSize + ", h=" + heightSpecSize + ", displayAspectRadio=" + displayAspectRatio + ", specAspectRadio=" + specAspectRatio);
                switch (mCurrentAspectRatio) {
                    case VideoType.AR_ASPECT_FIT_PARENT:
                    case VideoType.AR_16_9_FIT_PARENT:
                    case VideoType.AR_4_3_FIT_PARENT:
        ...
        Logger.d("doMeasure on surfaceview complete, w=" + mMeasuredWidth + ", h=" + mMeasuredHeight);
    }
